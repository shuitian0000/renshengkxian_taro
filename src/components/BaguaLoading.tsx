      ...
      <View className="relative w-32 h-32 mb-8">
        ...
        <View className="absolute inset-0 flex items-center justify-center">
          <View
            ...
            style={{animationDuration: '3s', backgroundColor: '#1A1A1A'}}>
            {/* 阳鱼（白色）- 左半边 + 右上角半圆 */}
            <View className="absolute left-0 top-0 w-1/2 h-full" style={{backgroundColor: '#F5F0E6'}} />
            <View className="absolute right-1/4 top-0 w-1/2 h-1/2 rounded-full" style={{backgroundColor: '#F5F0E6'}} />
            {/* 阴鱼（金色）- 右半边 + 左下角半圆 */}
            <View className="absolute right-0 top-0 w-1/2 h-full" style={{backgroundColor: '#D4AF37'}} />
            <View
              className="absolute left-1/4 bottom-0 w-1/2 h-1/2 rounded-full"
